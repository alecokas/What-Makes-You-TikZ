...
\begin{tikzpicture}
    ...
    \draw[stateTransition] (n6) to[out=-15,in=185] node [midway, sloped, above] {\Large{wick}} (n2);
    ...
    \draw[stateTransition] (n2) to[out=5,in=190] node [midway, sloped, below] {\Large{gown}} (n4);
